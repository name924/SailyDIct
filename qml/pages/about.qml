...
//                    console.log("clicked: " + link);
                ...
                function getText() {
                    ...
                    + "<br>"
                    + "<br>SailyDict began as an attempt to solve the problenm in Sidudict where the dictionay is indexed each time the application is started, thereby increasing startup latency."
                    + "<br>"
                    ...
                    + "<br><a href='https://github.com/name924/testsql'>"
                    + "https://github.com/name924/testsql</a>"
                    + "<br>"
